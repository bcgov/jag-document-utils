...
import ca.bc.gov.open.pssg.docmerge.model.Document;
import ca.bc.gov.open.pssg.docmerge.model.Options;
...
public class MergeServiceImplTest {
    ...
    public void beforeAll() throws OperationException {
        ...
        Mockito.when(assemblerServiceClientMock.invokeDDX(Mockito.any(), Mockito.any(), Mockito.any()))
                .thenReturn(assemblerResultMock);
